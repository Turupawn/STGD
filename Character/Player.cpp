...
Player::Player(Sound* sonido,RosalilaGraphics* painter,Receiver* receiver,std::string name)
{
    ...
    this->raped=false;
    this->cont_release_rape=0;
    this->cont_release_rape=false;
...
void Player::inputControl()
{
       ...
       || receiver->IsJoyDown(-4,0))
    {
        ...
        if(unbind_right_press)
            cont_release_rape--;
        unbind_right_press=false;
        orientation="left";
    }
